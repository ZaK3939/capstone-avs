...
import {UniGuardServiceManagerSetup} from "test/UniGuardServiceManager.t.sol";
import {
    Quorum,
    StrategyParams,
    IStrategy
...
contract SetupPaymentsLibTest is Test, TestConstants, UniGuardServiceManagerSetup {
